function [ vEstParams, mEstCov ] = ApplyLs( vMeasurements, mModel, vNoiseVar )
% ----------------------------------------------------------------------------------------------- %
...
mCovInv = diag(1 ./ vNoiseVar);

vEstParams  = (mModel.' * mCovInv * mModel) \ (mModel.' * mCovInv) * vMeasurements;
mEstCov     = inv(mModel.' * mCovInv * mModel);
